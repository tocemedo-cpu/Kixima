...
| Rotas Node | Endpoints | Serviço(s) Node | Notas |
|---|---|---|---|
| `/api/admin` (invites de assessor, users/areas/status, activities, prontidão, email-teste) | 14 | adminService (320), prontidaoService (675) | convites ADMIN_SISTEMA, prontidão para produção |
