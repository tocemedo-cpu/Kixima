...
1. Escolher o próximo domínio pela tabela de prioridade acima. **Toda a
   ...
   também está **migrada** — restam do Company Admin só as páginas restantes
   da tabela acima (ver estado de cada uma). Os próximos candidatos com bom
   custo/benefício: `admin/{Companies,Contracts,Cobrancas}.jsx` (740 linhas ao
   todo), ou começar a prioridade 3 do Fornecedor/Comprador. Repare que
