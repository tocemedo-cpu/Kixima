...
1. Escolher o próximo domínio pela tabela de prioridade acima. **Toda a
   ...
   3 (`Activities,CategoryManagement,PoRobot`). Os próximos candidatos com bom
   custo/benefício: `companyAdmin/{Assinatura}.jsx` (446 linhas, sozinha),
   `admin/{Companies,Contracts,Cobrancas}.jsx` (740 linhas ao todo), ou
   começar a prioridade 3 do Fornecedor/Comprador. Repare que
