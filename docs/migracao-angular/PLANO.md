...
1. Escolher o próximo domínio pela tabela de prioridade acima. **Toda a
   ...
   **migradas** — restam do Company Admin e do Admin do Sistema só as páginas
   ...
   prioridade 3). Os próximos candidatos com bom custo/benefício: começar a
   prioridade 3 do Fornecedor/Comprador/Admin do Sistema, ou as páginas
   `Profile.jsx`/`Security.jsx`/`Notifications.jsx` partilhadas (prioridade 2,
   usadas por todas as personas). Repare que
